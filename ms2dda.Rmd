...
Using this function MS2 spectra can be consolidated and only spectra retained that are within a certain limit around a detected peak. This drastically reduces the number of spectra that have to be processed.
